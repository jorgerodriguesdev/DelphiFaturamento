...
type
  TFImpCotacao2 = class(TFormularioPermissao)
...
procedure TFImpCotacao2.FormClose(Sender: TObject; var Action: TCloseAction);
begin
   CadOrcamento.close;
   MovOrcamento.close;
   aux.close;
...
procedure TFImpCotacao2.FormCreate(Sender: TObject);
begin
  Item := 0;
  MudaCabecalho;
end;
...
procedure TFImpCotacao2.VisualizaImpressao(VpaOrcamento, NroOrcamento : String);
begin
...
{************************** imprime a cotacao *********************************}
procedure TFImpCotacao2.ImprimeCotacao(VpaOrcamento,  NroOrcamento : String);
begin
  CarregaRelatorio(VpaOrcamento, NroOrcamento);
  QuickRep1.Print;
  close;
...
procedure TFImpCotacao2.CarregaCabecalho(VpaOrcamento,  NroOrcamento : String);
begin
   CarregaNomeFilial;
...
procedure TFImpCotacao2.CarregaCliente(Codigo :Integer);
Var
  VpfCGCCPF : String;
begin
...
procedure TFImpCotacao2.CarregaCadOrcamento(VpaOrcamento,  NroOrcamento : String);
begin
...
procedure TFImpCotacao2.CarregaNomeFilial;
begin
...
procedure TFImpCotacao2.CarregaProdutos(VpaOrcamento : String);
begin
...
procedure TFImpCotacao2.PosicionaProdutos(VpaOrcamento : String);
var
  Produto : string;
begin
...
procedure TFImpCotacao2.CorpoProdutosBeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TFImpCotacao2.CarregaServicos(VpaOrcamento : String);
begin
...
procedure TFImpCotacao2.QRSubDetail1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TFImpCotacao2.ChildBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TFImpCotacao2.CarregaParcelas(condicao,Orcamento : Integer);
var
   laco : Integer;
...
function TFImpCotacao2.ValorOrcamento : double;
begin
  result := 0;
  MovOrcamento.First;
...
procedure TFImpCotacao2.AdicionaCabecalhoParcelas(Parcelas : TQRMemo);
begin
...
Function TFImpCotacao2.NomeCondicao(Codigo : Integer) : String;
begin
   aux.close;
   aux.sql.clear;
...
procedure TFImpCotacao2.CarregaFotoProduto(Produto : String);
begin
   try
...
Function TFImpCotacao2.PathFoto(Produto:String) : String;
begin
...
Function TFImpCotacao2.ProdutoFoto : string;
begin
   MovOrcamento.First;
   While not MovOrcamento.eof do
   begin
...
procedure TFImpCotacao2.QRBand3BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TFImpCotacao2.PosicionaImpressora;
  var
  VpfLaco : Integer;
begin
...
procedure TFImpCotacao2.CarregaRelatorio(VpaOrcamento,  NroOrcamento : String);
begin
   PosicionaImpressora;
...
procedure TFImpCotacao2.MudaCabecalho;
